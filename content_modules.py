...
def create_check_result(main_url,target_dates,target,selected_hole):
    ...
    try:
        ...
        # 台番別データフレームの整形
        column_name = ["台番", "勝ち_結果", "台数_結果", "差枚_結果", "G数_結果", "BB確率_結果", "RB確率_結果", "合成確率_結果", "payout_結果", "合計差枚_結果", "合計G数_結果", "最大BB_結果", "最大RB_結果", "合計BB_結果", "合計RB_結果", "平均BB_結果", "平均RB_結果",
                        "勝ち_比較", "台数_比較", "平均差枚_比較", "平均G数_比較", "BB確率_比較", "RB確率_比較", "合成確率_比較", "payout_比較", "合計差枚_比較", "合計G数_比較", "最大BB_比較", "最大RB_比較", "合計BB_比較", "合計RB_比較", "平均BB_比較", "平均RB_比較"]
